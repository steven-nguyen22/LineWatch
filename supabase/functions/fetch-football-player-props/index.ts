 ...
 * Handles variance between ESPN ("Odell Beckham Jr.", "Patrick Mahomes II",
 * "D.K. Metcalf", "D'Andre Swift") and The Odds API ("Odell Beckham Jr",
 * "Patrick Mahomes", "DK Metcalf", "DAndre Swift"). Strips:
 *  - diacritics / accents
 ...
 *
 * `teams` is keyed by the canonical ESPN displayName (e.g. "Odell Beckham Jr."),
