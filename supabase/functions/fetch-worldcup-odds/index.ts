...
// FIFA World Cup. The Odds API uses a single year-agnostic key that serves
// whichever World Cup is currently active (2026 in North America, Jun 11 –
// Jul 19). Returns an empty array until books post lines ~1-2 weeks out —
// the upsert below handles an empty `data` array without error. Surfaced on
// iOS inside the Soccer section alongside soccer_uefa_champs_league (see
// SportCategory.sportKeys in LinesManager.swift).
